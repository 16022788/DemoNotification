package com.wordpress.yinghengsite.demonotification;
...
public class MainActivity extends AppCompatActivity {
    ...
    Button btnNotify1, getBtnNotify2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNotify1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Notification Style, Big Text Style
                ...
                //This replaces the existing notiication with the same ID
